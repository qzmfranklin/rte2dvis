...
int LynessRule::i4_max ( int i1, int i2 )
...
int LynessRule::i4_min ( int i1, int i2 )
...
int LynessRule::i4_modp ( int i, int j )
...
int LynessRule::i4_wrap ( int ival, int ilo, int ihi )
...
int *LynessRule::i4vec_copy_new ( int n, int a1[] )
...
int LynessRule::lyness_order ( int rule )
...
int LynessRule::lyness_precision ( int rule )
...
void LynessRule::lyness_rule ( int rule, int order, double w[], double x[] )
...
int LynessRule::lyness_rule_num ( )
...
int *LynessRule::lyness_suborder ( int rule, int suborder_num )
...
int LynessRule::lyness_suborder_num ( int rule )
...
void LynessRule::lyness_subrule ( int rule, int suborder_num, double sub_xyz[], 
  double sub_w[] )
...
double LynessRule::r8_abs ( double x )
...
void LynessRule::r8mat_copy ( int m, int n, double a1[], double a2[] )
...
void LynessRule::r8mat_write ( string output_filename, int m, int n, double table[] )
...
void LynessRule::r8vec_copy ( int n, double a1[], double a2[] )
...
double LynessRule::r8vec_sum ( int n, double a[] )
