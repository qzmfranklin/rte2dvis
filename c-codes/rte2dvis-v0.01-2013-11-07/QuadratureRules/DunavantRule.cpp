...
namespace QuadratureRules { 
	...
	int DunavantRule::dunavant_order_num ( int rule )
	...
	void DunavantRule::dunavant_rule ( int rule, int order_num, double xy[], double w[] )
	...
	int DunavantRule::dunavant_rule_num ( )
	...
	int *DunavantRule::dunavant_suborder ( int rule, int suborder_num )
	...
	int DunavantRule::dunavant_suborder_num ( int rule )
	...
	void DunavantRule::dunavant_subrule ( int rule, int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_01 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_02 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_03 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_04 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_05 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_06 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_07 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_08 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_09 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_10 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_11 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_12 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_13 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_14 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_15 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_16 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_17 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_18 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_19 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::dunavant_subrule_20 ( int suborder_num, double suborder_xyz[],
			double suborder_w[] )
	...
	void DunavantRule::file_name_inc ( char *file_name )
	...
	int DunavantRule::i4_max ( int i1, int i2 )
	...
	int DunavantRule::i4_min ( int i1, int i2 )
	...
	int DunavantRule::i4_modp ( int i, int j )
	...
	int DunavantRule::i4_wrap ( int ival, int ilo, int ihi )
	...
	int DunavantRule::r8_nint ( double x )
	...
	void DunavantRule::reference_to_physical_t3 ( double t[], int n, double ref[], double phy[] )
	...
	int DunavantRule::s_len_trim ( char *s )
...
# undef TIME_SIZE
	...
	double DunavantRule::triangle_area ( double t[2*3] )
	...
	void DunavantRule::triangle_points_plot ( char *file_name, double node_xy[], int node_show,
