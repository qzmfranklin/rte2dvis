...
${BUILD}/test-SVD.exe: ${BUILD}/test-SVD.o ${BUILD}/Utils.o
################## DO NOT MODIFY ################
...
#  	Usually, ${DIR-SVD}INCS and ${DIR-SVD}LIBS should not need to be modified if
...
###############################################################################
############################################################################### 
#DIR-SVDECTORY-SPECIFIC PATTERN RULES
##  C++ linkage at the top level
#${BIN}/%.exe: ${BUILD}/%.o 
	#@echo Linking  "${B_RED}$@${NONE}"...
	#@${CXX} -o $@ ${filter %.o,$^} ${${DIR-SVD}LIBS} 
#${BUILD}/%.exe: ${BUILD}/%.o 
...
${BUILD}/%.o: ${DIR-SVD}/%.cpp
	...
	@${CXX} -o $@ -c $< ${${DIR-SVD}CXXFLAGS} ${${DIR-SVD}INCS}
${DEBUG}/%.s: ${DIR-SVD}/%.cpp
	@echo Generating "${CYAN}$@${NONE}"...
	@${CXX} -o $@ $< ${ASMFLAGS} ${${DIR-SVD}CXXFLAGS} ${${DIR-SVD}INCS} 
#  C sources
${BUILD}/%.o: ${DIR-SVD}/%.c
	@echo Compiling "${MAGENTA}$@${NONE}"...
	@${CC} -o $@ -c $< ${${DIR-SVD}CFLAGS} ${${DIR-SVD}INCS}
${DEBUG}/%.s: ${DIR-SVD}/%.c
	@echo Generating "${CYAN}$@${NONE}"...
	@${CC} -o $@ $< ${ASMFLAGS} ${${DIR-SVD}CFLAGS} ${${DIR-SVD}INCS} 
