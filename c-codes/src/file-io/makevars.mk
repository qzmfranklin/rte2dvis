...
#  	Usually, ${DIR-file-io}INCS and ${DIR-file-io}LIBS should not need to be modified if
...
#${DIR-file-io}LIBS		:=${LIBS} 
###############################################################################
#				STEP 6
#	Write whatever special dependencies here:
...
###############################################################################
############################################################################### 
#DIR-file-ioECTORY-SPECIFIC PATTERN RULES
##  C++ linkage at the top level
#${BIN}/%.exe: ${BUILD}/%.o 
	#@echo Linking  "${B_RED}$@${NONE}"...
	#@${CXX} -o $@ ${filter %.o,$^} ${${DIR-file-io}LIBS} 
#${BUILD}/%.exe: ${BUILD}/%.o 
...
${BUILD}/%.o: ${DIR-file-io}/%.cpp
	...
	@${CXX} -o $@ -c $< ${${DIR-file-io}CXXFLAGS} ${${DIR-file-io}INCS}
${DEBUG}/%.s: ${DIR-file-io}/%.cpp
	@echo Generating "${CYAN}$@${NONE}"...
	@${CXX} -o $@ $< ${ASMFLAGS} ${${DIR-file-io}CXXFLAGS} ${${DIR-file-io}INCS} 
#  C sources
${BUILD}/%.o: ${DIR-file-io}/%.c
	@echo Compiling "${MAGENTA}$@${NONE}"...
	@${CC} -o $@ -c $< ${${DIR-file-io}CFLAGS} ${${DIR-file-io}INCS}
${DEBUG}/%.s: ${DIR-file-io}/%.c
	@echo Generating "${CYAN}$@${NONE}"...
	@${CC} -o $@ $< ${ASMFLAGS} ${${DIR-file-io}CFLAGS} ${${DIR-file-io}INCS} 
