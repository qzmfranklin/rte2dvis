...
#
#  Remember to add the ${DIR-mat_cmpr/aca}/ to whatever source files(s) you wish to 
#  add.
...
################## DO NOT MODIFY ################
SRCFILES:=${SRCFILES} ${${DIR-mat_cmpr/aca}CFILES} \
	${${DIR-mat_cmpr/aca}CPPFILES} ${${DIR-mat_cmpr/aca}TSTCPP} \
	${${DIR-mat_cmpr/aca}BINCPP}
DEPFILES:=${DEPFILES} ${${DIR-mat_cmpr/aca}DEPFILES} \
	${${DIR-mat_cmpr/aca}TSTDEP} ${${DIR-mat_cmpr/aca}BINDEP}
################## DO NOT MODIFY ################
###############################################################################
###############################################################################
#				WANRING
...
${DIR-mat_cmpr/aca}-all: ${${DIR-mat_cmpr/aca}OBJFILES} ${${DIR-mat_cmpr/aca}BINEXE}		\
	${${DIR-mat_cmpr/aca}LIBFILES} ${${DIR-mat_cmpr/aca}BINLIB}
...
${DIR-mat_cmpr/aca}-list:
	...
	@$(foreach dir, 						\
		...
		,							\
		if [ ! -z "${${DIR-mat_cmpr/aca}${dir}}" ]; then 		\
			echo "${BROWN}${dir}${NONE}\t\c";		\
			$(foreach file,${${DIR-mat_cmpr/aca}${dir}},		\
			    if [ -f ${file} ]; then echo		\
				"${BLACK}${file}${NONE}\c";		\
