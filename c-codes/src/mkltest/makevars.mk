...
DIR004		:=src/mkltest# Please, NO SPACE 
###############################################################################
#				STEP 2
#DIRECTORY-SPECIFIC SOURCE FILES
#  	Remember to add the ${DIR004}/ to whatever source files(s) you wish to add.
...
${DIR004}CPPFILES	:=	
################## DO NOT MODIFY ################
${DIR004}OBJFILES	:=	${${DIR004}CPPFILES:${DIR004}%.cpp=${BUILD}%.o}	\
				${${DIR004}CFILES:${DIR004}%.c=${BUILD}%.o}
${DIR004}DEPFILES	:=	${${DIR004}OBJFILES:%.o=%.d}
${DIR004}ASMFILES	:=	${${DIR004}OBJFILES:${BUILD}%.o=${DEBUG}%.s}
################## DO NOT MODIFY ################ 
###############################################################################
#				STEP 3
...
${DIR004}BIN	:=		
################## DO NOT MODIFY ################
${DIR004}BINCPP	:=		${${DIR004}BIN:%=${DIR004}/%.cpp}
${DIR004}BINOBJ	:=		${${DIR004}BINCPP:${DIR004}%.cpp=${BUILD}%.o}
${DIR004}BINDEP	:=		${${DIR004}BINOBJ:%.o=%.d}
${DIR004}BINEXE	:=		${${DIR004}BINOBJ:${BUILD}%.o=${BIN}%.exe}
${DIR004}BINASM	:=		${${DIR004}BINOBJ:${BUILD}%.o=${DEBUG}%.s}
################## DO NOT MODIFY ################
#  The default build rule for ${DIR004}BINEXE is:
${${DIR004}BINEXE}: ${${DIR004}BINOBJ} ${${DIR004}OBJFILES} 
...
#  listing the them in ${DIR004}TST, do NOT write the .cpp extension. For example:
#  if one wishes to add test-mytest.cpp, he should write:
#
#  		${DIR004}TST:=test-mytest
#
${DIR004}TST	:=		test-mkl
################## DO NOT MODIFY ################
${DIR004}TSTCPP	:=		${${DIR004}TST:%=${DIR004}/%.cpp}
${DIR004}TSTOBJ	:=		${${DIR004}TSTCPP:${DIR004}%.cpp=${BUILD}%.o}
${DIR004}TSTDEP	:=		${${DIR004}TSTOBJ:%.o=%.d}
${DIR004}TSTEXE	:=		${${DIR004}TSTOBJ:%.o=%.exe}
${DIR004}TSTASM	:=		${${DIR004}TSTOBJ:${BUILD}%.o=${DEBUG}%.s}
SRCFILES	:=		${SRCFILES} ${${DIR004}CFILES} ${${DIR004}CPPFILES} ${${DIR004}TSTCPP} ${${DIR004}BINCPP}
DEPFILES	:=		${DEPFILES} ${${DIR004}DEPFILES} ${${DIR004}TSTDEP} ${${DIR004}BINDEP}
################## DO NOT MODIFY ################
#  The default build rule for ${DIR004}BINEXE is:
${${DIR004}TSTEXE}: ${${DIR004}TSTOBJ} ${${DIR004}OBJFILES} 
...
# 	 	${DIR004}CFLAGS	:=${CFLAGS} [directory-specific options]
#  	Usually, ${DIR004}INCS and ${DIR004}LIBS should not need to be modified if
...
${BUILD}/test-mkl.exe: ${BUILD}/Utils.o
...
###############################################################################
############################################################################### 
#DIR004ECTORY-SPECIFIC PATTERN RULES
#  C++ linkage at the top level
${BIN}/%.exe: ${BUILD}/%.o 
	@echo Linking  "${B_RED}$@${NONE}"...
	@${CXX} -o $@ ${filter %.o,$^} ${${DIR004}LIBS} 
${BUILD}/%.exe: ${BUILD}/%.o 
...
${BUILD}/%.o: ${DIR004}/%.cpp
	...
	@${CXX} -o $@ -c $< ${${DIR004}CXXFLAGS} ${${DIR004}INCS}
${DEBUG}/%.s: ${DIR004}/%.cpp
	@echo Generating "${CYAN}$@${NONE}"...
	@${CXX} -o $@ $< ${ASMFLAGS} ${${DIR004}CXXFLAGS} ${${DIR004}INCS} 
#  C sources
${BUILD}/%.o: ${DIR004}/%.c
	@echo Compiling "${MAGENTA}$@${NONE}"...
	@${CC} -o $@ -c $< ${${DIR004}CFLAGS} ${${DIR004}INCS}
${DEBUG}/%.s: ${DIR004}/%.c
	@echo Generating "${CYAN}$@${NONE}"...
	@${CC} -o $@ $< ${ASMFLAGS} ${${DIR004}CFLAGS} ${${DIR004}INCS} 
#DIR004ECTORY-SPECIFIC PHONY TARGETS
.PHONY: ${DIR004}-all ${DIR004}-test ${DIR004}-asm ${DIR004}-list
...
${DIR004}-list:
	...
	@echo "${BROWN}CFILES${NONE}":${${DIR004}CFILES}
	@echo "${BROWN}CPPFILES${NONE}":${${DIR004}CPPFILES}
	@echo "${BROWN}OBJFILES${NONE}":${${DIR004}OBJFILES}
	@echo "${BROWN}DEPFILES${NONE}":${${DIR004}DEPFILES}
	@echo "${BROWN}ASMFILES${NONE}":${${DIR004}ASMFILES}
	@echo "${BROWN}TSTCPP${NONE}":${${DIR004}TSTCPP}
	@echo "${BROWN}TSTOBJ${NONE}":${${DIR004}TSTOBJ}
	@echo "${BROWN}TSTDEP${NONE}":${${DIR004}TSTDEP}
	@echo "${BROWN}TSTEXE${NONE}":${${DIR004}TSTEXE}
	@echo "${BROWN}TSTASM${NONE}":${${DIR004}TSTASM} 
	@echo "${BROWN}BINCPP${NONE}":${${DIR004}BINCPP}
	@echo "${BROWN}BINOBJ${NONE}":${${DIR004}BINOBJ}
	@echo "${BROWN}BINDEP${NONE}":${${DIR004}BINDEP}
	@echo "${BROWN}BINEXE${NONE}":${${DIR004}BINEXE}
	@echo "${BROWN}BINASM${NONE}":${${DIR004}BINASM} 
