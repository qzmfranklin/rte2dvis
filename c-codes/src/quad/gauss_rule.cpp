...
namespace QuadratureRules {
	...
	/******************************************************************************/ 
	GaussQuadratures gGaussQuadratures; 
	/******************************************************************************/ 
	void GaussQuadratures::cdgqf ( int nt, int kind, double alpha, double beta, double t[], double wts[] )
		/*
		   Purpose:
	...
	/******************************************************************************/
	void GaussQuadratures::cgqf ( int nt, int kind, double alpha, double beta, double a, double b, double t[], double wts[] )
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	double GaussQuadratures::class_matrix ( int kind, int m, double alpha, double beta, double aj[], double bj[] ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	void GaussQuadratures::imtqlx ( int n, double d[], double e[], double z[] ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	void GaussQuadratures::parchk ( int kind, int m, double alpha, double beta ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	double GaussQuadratures::r8_abs ( double x ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	double GaussQuadratures::r8_epsilon ( ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	double GaussQuadratures::r8_gamma ( double x ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	double GaussQuadratures::r8_sign ( double x ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	void GaussQuadratures::r8mat_write ( char *output_filename, int m, int n, double table[] ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	void GaussQuadratures::rule_write ( int order, char *filename, double x[], double w[], double r[] ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	void GaussQuadratures::scqf ( int nt, double t[], int mlt[], double wts[], int nwts, int ndx[], double swts[], double st[], int kind, double alpha, double beta, double a, double b ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	void GaussQuadratures::sgqf ( int nt, double aj[], double bj[], double zemu, double t[], double wts[] ) 
		/*
		   Purpose:
	...
	/******************************************************************************/ 
	void GaussQuadratures::timestamp ( void ) 
		/*
		   Purpose:
