...
#  listing the them in ${DIR-test_mem_bw/mem_bw}TST, do NOT write the .cpp extension. For example:
...
${DIR-test_mem_bw/mem_bw}TST	:=		test_sumcopy time_sumcopy
...
${DIR-test_mem_bw/mem_bw}-list:
	...
	@echo "${BROWN}CFILES${NONE}":${${DIR-test_mem_bw/mem_bw}CFILES}
	@echo "${BROWN}CPPFILES${NONE}":${${DIR-test_mem_bw/mem_bw}CPPFILES}
	@echo "${BROWN}OBJFILES${NONE}":${${DIR-test_mem_bw/mem_bw}OBJFILES}
	@echo "${BROWN}DEPFILES${NONE}":${${DIR-test_mem_bw/mem_bw}DEPFILES}
	@echo "${BROWN}ASMFILES${NONE}":${${DIR-test_mem_bw/mem_bw}ASMFILES}
	@echo "${BROWN}TSTCPP${NONE}":${${DIR-test_mem_bw/mem_bw}TSTCPP}
	@echo "${BROWN}TSTOBJ${NONE}":${${DIR-test_mem_bw/mem_bw}TSTOBJ}
	@echo "${BROWN}TSTDEP${NONE}":${${DIR-test_mem_bw/mem_bw}TSTDEP}
	@echo "${BROWN}TSTEXE${NONE}":${${DIR-test_mem_bw/mem_bw}TSTEXE}
	@echo "${BROWN}TSTASM${NONE}":${${DIR-test_mem_bw/mem_bw}TSTASM} 
	@echo "${BROWN}BINCPP${NONE}":${${DIR-test_mem_bw/mem_bw}BINCPP}
	@echo "${BROWN}BINOBJ${NONE}":${${DIR-test_mem_bw/mem_bw}BINOBJ}
	@echo "${BROWN}BINDEP${NONE}":${${DIR-test_mem_bw/mem_bw}BINDEP}
	@echo "${BROWN}BINEXE${NONE}":${${DIR-test_mem_bw/mem_bw}BINEXE}
	@echo "${BROWN}BINASM${NONE}":${${DIR-test_mem_bw/mem_bw}BINASM} 
