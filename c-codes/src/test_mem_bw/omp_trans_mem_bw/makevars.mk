...
${DIR-test_mem_bw/-omp_trans_mem_bw}ASMFILES	:=	${${DIR-test_mem_bw/-omp_trans_mem_bw}OBJFILES:${BUILD}%.o=${DEBUG}%.s}
################## DO NOT MODIFY ################ 
###############################################################################
#				STEP 3
...
${DIR-test_mem_bw/-omp_trans_mem_bw}BINASM	:=		${${DIR-test_mem_bw/-omp_trans_mem_bw}BINOBJ:${BUILD}%.o=${DEBUG}%.s}
################## DO NOT MODIFY ################
###############################################################################
#				STEP 4
...
${DIR-test_mem_bw/-omp_trans_mem_bw}TSTASM	:=		${${DIR-test_mem_bw/-omp_trans_mem_bw}TSTOBJ:${BUILD}%.o=${DEBUG}%.s}
...
${DEBUG}/%.s: ${DIR-test_mem_bw/-omp_trans_mem_bw}/%.cpp
...
${DEBUG}/%.s: ${DIR-test_mem_bw/-omp_trans_mem_bw}/%.c
	@echo Generating "${CYAN}$@${NONE}"...
