...
/******************************************************************************/
void GaussRule::cgqf ( int nt, int kind, double alpha, double beta, double a, double b, double t[], double wts[] )
	/*
	   Purpose:
...
/******************************************************************************/ 
double GaussRule::class_matrix ( int kind, int m, double alpha, double beta, double aj[], double bj[] ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
void GaussRule::imtqlx ( int n, double d[], double e[], double z[] ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
void GaussRule::parchk ( int kind, int m, double alpha, double beta ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
double GaussRule::r8_abs ( double x ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
double GaussRule::r8_gamma ( double x ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
double GaussRule::r8_sign ( double x ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
void GaussRule::r8mat_write ( char *output_filename, int m, int n, double table[] ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
void GaussRule::rule_write ( int order, char *filename, double x[], double w[], double r[] ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
void GaussRule::scqf ( int nt, double t[], int mlt[], double wts[], int nwts, int ndx[], double swts[], double st[], int kind, double alpha, double beta, double a, double b ) 
	/*
	   Purpose:
...
/******************************************************************************/ 
void GaussRule::sgqf ( int nt, double aj[], double bj[], double zemu, double t[], double wts[] ) 
	/*
	   Purpose:
